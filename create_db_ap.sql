...
DROP DATABASE IF EXISTS ap; CREATE DATABASE ap;
/* select the database */
...
CREATE TABLE invoice_line_items (
    ...
    CONSTRAINT line_items_fk_acounts FOREIGN KEY (account_number)
        REFERENCES general_ledger_accounts (account_number)
);
/* create the indexes */
...
/* create some test tables that aren't explicitly    related to the previous five tables */
